...
namespace SQLite.Tests {
	...
	public class MappingTests {
		...
		class AFunnyTableName {
			...
			[Column("AGoodColumnName")] public string AFunnyColumnName { get; set; }
		...
		class OverrideNamesClass : OverrideNamesBase {
			...
			[Column("n")] public override string Name { get; set; }
			[Column("v")] public override string Value { get; set; }
		...
		public class Foo {
			...
			[Column("baz")] public int Bar { get; set; }
		...
		public class OnlyKeyModel {
			...
			[PrimaryKey] public string MyModelId { get; set; }
