...
namespace SQLite.Tests {
	...
	public class IgnoreTests {
		...
		public class TestObj {
			...
			[SQLite.Ignore] public string IgnoredText { get; set; }
		...
		public class BaseClass {
			...
			[Ignore] public string ToIgnore { get; set; }
		...
		public class RedefinedClass : RedefinedBaseClass {
			...
			[Ignore] public new List<string> Values { get; set; }
		...
		class DerivedIgnoreClass {
			...
			[DerivedIgnore] public string Ignored { get; set; }
