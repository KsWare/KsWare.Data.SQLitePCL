...
namespace SQLite.Tests {
	...
	public class NullableTests {
		...
		public void WhereNotNull() {
			...
			NullableIntClass[] results = db.Table<NullableIntClass>().Where(x => x.NullableInt != null)
		...
		public class NullableEnumClass {
			...
			public override bool Equals(object obj) {
				...
				return this.ID == other.ID && this.NullableIntEnum == other.NullableIntEnum &&
				       this.NullableTextEnum == other.NullableTextEnum;
			}
			...
			public override string ToString() {
				return string.Format("[NullableEnumClass: ID={0}, NullableIntEnum={1}, NullableTextEnum={2}]", ID,
					NullableIntEnum, NullableTextEnum);
			}
