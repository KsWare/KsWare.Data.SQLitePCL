# KsWare.Data.SQLitePCL

Fork of SQLite-net

**Motivation:**  
With over 500 open issues and over 50 open pull requests but no updates since 2 years, it seemed pointless to open more PRs in SQLite-net to fix bugs and implement features I was interested in and then wait in vain for them to be merged.

My intentions: 
- .NET: continue support
- .NET Framework: continue support
- Xamarin: no support (out of support at Mai 2024 through Microsoft)
- iOS: no support (not my bussines)

# Unchanged original README
